            ...
            if (MyEconomy) {
                if (MyUser) {
                    ...
                    if (amount == "all") {
                        ...
                        if (balance % 1 != 0 || balance <= 0) return message.reply("You are currently in debt and are not able to deposit anything!");
                        ...
                        await MyUser.updateOne({
                            ...
                            const response = new MessageEmbed({
                                description: `You have deposited **${MyEconomy.currency}${balance}** into your bank.`,
                                color: "GREEN"
                            });
                        ...
                        try {
                            ...
                            if (amount > MyUser.wallet.balance) return message.channel.send("You don't have that amount of money to deposit.");
                            ...
                            await MyUser.updateOne({
                                ...
                                const response = new MessageEmbed({
                                    description: `You have deposited **${MyEconomy.currency}${amount}** into your bank`,
